	...
	for i := 0; i < ms.Len(); i++ {
		...
		case metadata.M.PostgresqlBlocksRead.Name():
			...
			require.Equal(t, map[string]int64{
				...
				"postgresql.blocks_read otel table1 heap_read":   19,
				"postgresql.blocks_read otel table1 heap_hit":    20,
				"postgresql.blocks_read otel table1 idx_read":    21,
				"postgresql.blocks_read otel table1 idx_hit":     22,
				"postgresql.blocks_read otel table1 toast_read":  23,
				"postgresql.blocks_read otel table1 toast_hit":   24,
				"postgresql.blocks_read otel table1 tidx_read":   25,
				"postgresql.blocks_read otel table1 tidx_hit":    26,
				"postgresql.blocks_read otel table2 heap_read":   27,
				"postgresql.blocks_read otel table2 heap_hit":    28,
				"postgresql.blocks_read otel table2 idx_read":    29,
				"postgresql.blocks_read otel table2 idx_hit":     30,
				"postgresql.blocks_read otel table2 toast_read":  31,
				"postgresql.blocks_read otel table2 toast_hit":   32,
				"postgresql.blocks_read otel table2 tidx_read":   33,
				"postgresql.blocks_read otel table2 tidx_hit":    34,
			}, metrics)
		...
		case metadata.M.PostgresqlDbRows.Name():
			...
			require.Equal(t, map[string]float64{
				...
				"postgresql.db_rows otel table1 live":  7,
				"postgresql.db_rows otel table1 dead":  8,
				"postgresql.db_rows otel table2 live":  9,
				"postgresql.db_rows otel table2 dead":  10,
			}, metrics)
		...
		case metadata.M.PostgresqlOperations.Name():
			...
			require.Equal(t, map[string]int64{
				...
				"postgresql.operations otel table1 seq":            39,
				"postgresql.operations otel table1 seq_tup_read":   40,
				"postgresql.operations otel table1 idx":            41,
				"postgresql.operations otel table1 idx_tup_fetch":  42,
				"postgresql.operations otel table2 seq":            43,
				"postgresql.operations otel table2 seq_tup_read":   44,
				"postgresql.operations otel table2 idx":            45,
				"postgresql.operations otel table2 idx_tup_fetch":  46,
			}, metrics)
