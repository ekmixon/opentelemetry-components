	...
	for i := 0; i < metric.Len(); i++ {
		...
		case metadata.M.CouchdbHttpdRequestMethods.Name():
			...
			require.Equal(t, map[string]bool{
				"couchdb.httpd.request_methods method:COPY":    true,
				"couchdb.httpd.request_methods method:DELETE":  true,
				"couchdb.httpd.request_methods method:GET":     true,
				"couchdb.httpd.request_methods method:HEAD":    true,
				"couchdb.httpd.request_methods method:OPTIONS": true,
				"couchdb.httpd.request_methods method:POST":    true,
				"couchdb.httpd.request_methods method:PUT":     true,
			},
		...
		case metadata.M.CouchdbHttpdResponseCodes.Name():
			...
			require.Equal(t, map[string]bool{
				"couchdb.httpd.response_codes code:response_200": true,
				"couchdb.httpd.response_codes code:response_201": true,
				"couchdb.httpd.response_codes code:response_202": true,
				"couchdb.httpd.response_codes code:response_204": true,
				"couchdb.httpd.response_codes code:response_206": true,
				"couchdb.httpd.response_codes code:response_301": true,
				"couchdb.httpd.response_codes code:response_302": true,
				"couchdb.httpd.response_codes code:response_304": true,
				"couchdb.httpd.response_codes code:response_400": true,
				"couchdb.httpd.response_codes code:response_401": true,
				"couchdb.httpd.response_codes code:response_403": true,
				"couchdb.httpd.response_codes code:response_404": true,
				"couchdb.httpd.response_codes code:response_405": true,
				"couchdb.httpd.response_codes code:response_406": true,
				"couchdb.httpd.response_codes code:response_409": true,
				"couchdb.httpd.response_codes code:response_412": true,
				"couchdb.httpd.response_codes code:response_413": true,
				"couchdb.httpd.response_codes code:response_414": true,
				"couchdb.httpd.response_codes code:response_415": true,
				"couchdb.httpd.response_codes code:response_416": true,
				"couchdb.httpd.response_codes code:response_417": true,
				"couchdb.httpd.response_codes code:response_500": true,
				"couchdb.httpd.response_codes code:response_501": true,
