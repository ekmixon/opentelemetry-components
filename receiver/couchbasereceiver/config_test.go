	...
	t.Run("happy path", func(t *testing.T) {
		testCases := []struct {
			...
			},
			{
				desc:     "only host",
				rawUrl:   "127.0.0.1",
				expected: "http://127.0.0.1:8091",
			},
			{
				desc:     "host(local) and port",
				rawUrl:   "localhost:8091",
				expected: "http://localhost:8091",
			},
			{
				desc:     "host and port",
				rawUrl:   "127.0.0.1:8091",
				expected: "http://127.0.0.1:8091",
			},
			{
				desc:     "full path",
				rawUrl:   "http://localhost:8091/pools/default",
				expected: "http://localhost:8091",
			},
			{
				desc:     "full path",
				rawUrl:   "http://127.0.0.1:8091/pools/default",
				expected: "http://127.0.0.1:8091",
			},
			{
				desc:     "unique host no port",
				rawUrl:   "myAlias.Site",
				expected: "http://myAlias.Site:8091",
			},
			{
			...
			},
			{
				...
				rawUrl:   "myAlias.Site:1234/pools/default",
				expected: "http://myAlias.Site:1234",
			},
			{
				desc:     "only port",
			...
			},
			{
				...
				rawUrl:   "1234",
				expected: "http://1234:8091",
			},
			{
				desc:     "limitation: invalid ip",
				rawUrl:   "500.0.0.0.1.1",
				expected: "http://500.0.0.0.1.1:8091",
			},
		}
...
func TestValidateEndpointFormat(t *testing.T) {
	...
	ports := []string{"", ":8091", ":1234"}
	paths := []string{"", "/pools/default", "/nonsense"}
